...
from wtforms import StringField, PasswordField, SubmitField, SelectField, TextAreaField, FloatField, TimeField, BooleanField, EmailField, IntegerField, SelectMultipleField, widgets, MultipleFileField
...
class RestaurantForm(FlaskForm):
    ...
    type = SelectField('Restaurant Type', validators=[DataRequired()])
    ...
    def __init__(self, *args, **kwargs):
        ...
        from config import Config
        self.type.choices = [(c, c) for c in Config.CUISINE_TYPES]
...
class ProfileSettingsForm(FlaskForm):
    ...
    current_password = PasswordField('Current Password', validators=[Optional(), Length(min=6, max=60)])
